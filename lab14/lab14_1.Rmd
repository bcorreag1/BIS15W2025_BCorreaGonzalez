...
ui <- fluidPage(
      selectInput("x", #naming the select input "x"
                  "Select X variable", #what we want user to see
                  choices=c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), #these are the choices 
                  selected = "bill_length_mm") #drop down menu will start in bill length mm
)
...
ui <- fluidPage(
      selectInput("x", #naming the select input "x"
                  "Select X variable", #what we want user to see
                  choices=c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), #these are the choices 
                  selected = "bill_length_mm"), #drop down menu will start in bill length mm. make sure you use a comma to put together different select inputs
      
      selectInput("y", #naming the select input "Y"
                  "Select Y variable", #what we want user to see
                  choices=c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), #these are the choices 
                  selected = "bill_length_mm") #drop down menu will start in bill length mm
