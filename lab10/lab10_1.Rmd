...
penguins %>% 
  ...
  filter(sex!="NA") %>% 
  #na.omit() #will omit all of the NA's. (can be used at the start to omit all NAs in the entire dataframe)
  group_by(sex) %>% 
...
How could we represent this as a plot? BOXPLOTS SHOW ALL OF THIS !
```{r}
homerange %>% 
