...
```{r}
# range = boxplot
# two continous variables = scattterplot
```
...
elephants %>% 
  ...
  labs(,title= "Elephant Age vs. Height",
       x="Age",
       y= "Height") #add labels. NECESSSARY FOR MIDTERMS
```
...
elephants %>% 
  ...
  labs(,title= "Elephant Age vs. Height",
       x="Age",
       y= "Height") + 
  theme(plot.title=element_text(size=rel(1.5),hjust=0.5)) #centered title, made the title 1.5 times bigger than the axis. 
```
