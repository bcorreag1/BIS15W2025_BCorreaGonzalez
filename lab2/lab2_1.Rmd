...
#can be used as an object to change a class
```
...
This means that there is missing data within our data set, suggesting that NAs will not allow for a function to run properly. 
